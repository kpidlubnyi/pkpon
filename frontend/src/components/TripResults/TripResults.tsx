...
export const TripResults = () => {
  const { matchingTrips, selectTrip, isSearching, tripDetails, searchParams } = useRouteStore();
                  ...
                  <div className={css['time-info']}>
                    <span className={css['departure-time']}>
                      ...
                      {departureNormalized.daysOffset && (
                        <small className={css['day-offset']}>{departureNormalized.daysOffset}</small>
                      )}
                    </span>
                    ...
                    <span className={css['arrival-time']}>
                      ...
                      {arrivalNormalized.daysOffset && (
                        <small className={css['day-offset']}>{arrivalNormalized.daysOffset}</small>
                      )}
                    </span>
                  </div>
                </div>
